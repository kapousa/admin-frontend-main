...
function CompanyForm({ username, password }) {
  ...
  const [company, setCompany] = useState({
    name: '', category: '', size: '', location: '', description: '', website: '', revenue: '', founded: '', headquarters: '', mission: '', company_values: '', financialStatement: [{ key: '', value: '', action: '', link: '' }], investors: [{ key: '', value: '', action: '', link: '' }], assessment: [{ key: '', value: '', action: '', link: '' }], portfolio: [{ key: '', value: '', action: '', link: '' }], logoFile: null,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    for (const key in companyData) {
      if (key === 'company_values' || key === 'investors' || key === 'financialStatement' || key === 'assessment' || key === 'portfolio' || key === 'dynamicSections') {
  ...
  const jsonFields = [{ name: 'financialStatement', label: 'Financial Statement' }, { name: 'portfolio', label: 'Portfolio' }, { name: 'investors', label: 'Investors' }, { name: 'assessment', label: 'Assessment' }];
